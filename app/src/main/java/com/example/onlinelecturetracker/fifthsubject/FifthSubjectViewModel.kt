...
class FifthSubjectViewModel(application: Application) : AndroidViewModel(application) {
    ...
    init {
        ...
        readAllData = repository.readAllElectiveData
        totalLectureDuration = repository.totalElectiveLecturesDuration
    }

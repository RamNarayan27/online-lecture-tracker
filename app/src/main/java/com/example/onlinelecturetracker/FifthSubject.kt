...
class FifthSubject : Fragment() {
    ...
    companion object {
        fun newInstance() = FifthSubject()
    }

    private lateinit var viewModel: FifthSubjectViewModel
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fifth_subject_fragment, container, false)
    }
